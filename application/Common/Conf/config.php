...
$configs= array(
        ...
        /* 标签库 */
        'TAGLIB_BUILD_IN' => SIMPLE_CORE_TAGLIBS,
        'MODULE_ALLOW_LIST'  => array('Portal','Admin','Asset','Api','User','Comment','Install'),
        ...
        'SP_TMPL_PATH'     		=> 'template/home/',       // 前台模板文件根目录
        ...
        'SP_ADMIN_STYLE'		=> 'simplestyle',
        'SP_ADMIN_TMPL_PATH'    => 'template/admin/',       // 各个项目后台模板文件根目录
        'SP_ADMIN_DEFAULT_THEME'=> 'leftnav',       // 后台模板文件
        ...
        'TMPL_EXCEPTION_FILE'   => SITE_PATH.'/template/public/exception.html',
