...
class NavController extends AdminbaseController {
	...
	public function index() {
		...
		$tree->nbsp = '&nbsp;&nbsp;&nbsp;';
		foreach ($result as $r) {
			$r['str_manage'] = '<a href="' . U("nav/add", array("parentid" => $r['id'],"cid"=>$r['cid'])) . '" class="btn btn-primary btn-xs" data-toggle="tooltip" data-placement="top" title="'.L('ADD_SUB_NAV').'"><i class="fa fa-plus-square-o fa-fw"></i></a>   <a href="' . U("nav/edit", array("id" => $r['id'],"parentid"=>$r['parentid'],"cid"=>$r['cid'])) . '" class="btn btn-primary btn-xs" data-toggle="tooltip" data-placement="top" title="'.L('EDIT').'"><i class="fa fa-edit fa-fw"></i></a>   <a class="btn btn-danger btn-xs js-ajax-delete" href="' . U("nav/delete", array("id" => $r['id'])) . '" data-toggle="tooltip" data-placement="top" title="'.L('DELETE').'"><i class="fa fa-trash-o fa-fw"></i></a> ';
	...
	public function add() {
		...
		foreach ($result as $r) {
			$r['str_manage'] = '<a href="' . U("Menu/add", array("parentid" => $r['id'], "menuid" => I("get.menuid"))) . '" class="btn btn-primary btn-xs" data-toggle="tooltip" data-placement="top" title="添加子菜单"><i class="fa fa-plus-square-o fa-fw"></i></a> | <a href="' . U("Menu/edit", array("id" => $r['id'], "menuid" => I("get.menuid"))) . '" " class="btn btn-primary btn-xs" data-toggle="tooltip" data-placement="top" title="修改"><i class="fa fa-edit fa-fw"></i></a>   <a class="btn btn-danger btn-xs js-ajax-delete" href="' . U("Menu/delete", array("id" => $r['id'], "menuid" => I("get.menuid"))) . '" data-toggle="tooltip" data-placement="top" title="删除"><i class="fa fa-trash-o fa-fw"></i></a> ';
