...
class MenuController extends AdminbaseController {
    ...
    public function index() {
        ...
        foreach ($result as $n=> $r) {
            ...
            $result[$n]['str_manage'] = '<a href="' . U("Menu/add", array("parentid" => $r['id'], "menuid" => I("get.menuid"))) . '" class="btn btn-primary btn-xs" data-toggle="tooltip" data-placement="top" title="'.L('ADD_SUB_MENU').'"><i class="fa fa-plus-square-o fa-fw"></i></a>   <a target="_blank" href="' . U("Menu/edit", array("id" => $r['id'], "menuid" => I("get.menuid"))) . '" class="btn btn-primary btn-xs" data-toggle="tooltip" data-placement="top" title="'.L('EDIT').'"><i class="fa fa-edit fa-fw"></i></a>   <a class="btn btn-danger btn-xs js-ajax-delete" href="' . U("Menu/delete", array("id" => $r['id'], "menuid" => I("get.menuid")) ). '" data-toggle="tooltip" data-placement="top" title="'.L('DELETE').'"><i class="fa fa-trash-o fa-fw"></i></a> ';
